...
router.get('/:id/download', auth_middleware.query_string_auth, middleware.can_download, controller.download);
...
router.get('/:id', middleware.can_update, controller.show);
router.put('/:id', middleware.can_update, controller.update);
router.post('/:id/add_user', middleware.add_user, controller.add_user);
router.post('/:id/remove_user', middleware.can_remove_user, middleware.remove_user, controller.remove_user);
